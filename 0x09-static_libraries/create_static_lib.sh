...
gcc -c 5-strstr.c -o 4-strstr.o
gcc -c 6-abs.c -o 6-abs.o
gcc -c 9-strcpy.c -o 9-strcpy.o
gcc -c _putchar.c -o _putchar.o
ar rc liball.a 0-isupper.o 0-memset.o 0-strcat.o 1-isdigit.o 1-memcpy.o 1-strncat.o 100-atoi.o 2-strchr.o 2-strlen.o 2-strncpy.o 3-islower.o 3-puts.o 3-strcmp.o 4-isalpha.o 3-strspn.o 4-strpbrk.o 4-strstr.o 6-abs.o 9-strcpy.o _putchar.o 
